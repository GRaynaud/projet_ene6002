...
\end{equation}
Dans l'équation ci-dessus, $x^i_k$ fait référence au titre évalué au k\up{ème} point de discretisation ($z_k = z_e + \frac{k}{N_z}L_c$) lors de la i\up{ème} itération . Cela permet de faire converger rapidement l'algorithme et ne pas trop contraindre la variation des différents paramètres.
